...
#define REQUEST_TERMINAL_KEY    175
...
typedef struct
{
	...
	BYTE szSubscriberNo[19+1];	/* ASCII string */
	int inFundTransferAccountType;
    BYTE szAccountNoTo[PAN_SIZE+1];
	BYTE szUserName[12+1];
	BYTE szAcquirerFee[12+1];
	BYTE szServiceFee2[12+1];
	BOOL fOnUs;
